...
<section class="card card--wide">
  ...
  <div class="card__body">
    ...
    <form id="frm_be" method="post" action="./send.php" autocomplete="off">
      ...
      <input type="hidden" id="default_mitarbeiter" value="<?= htmlspecialchars($defaultMitarbeiter, ENT_QUOTES); ?>">
      ...
      <section class="card card--wide be_card" id="sec_kunde">
        ...
        <div class="card__body">
          ...
          <div class="be_row">
            <div class="be_col be_col--grow autocomplete">
              ...
              <div class="be_customerline">
                <button class="chip chip--muted" type="button" id="be_customer_chip" title="Kunde löschen / ändern">Unbekannt</button>
              ...
              <div class="events-muted" id="be_customer_preview" style="margin-top:6px;"></div>
              <div id="be_customer_suggest" class="suggest" hidden></div>
            </div>
          </div>

          <div class="be_row be_row--grid2" style="margin-top:10px;">
            <div class="be_col">
          ...
          <div class="be_row" style="margin-top:10px;">
        ...
        <div class="card__body">
          ...
          <div class="be_row">
            <div class="be_col be_col--grow">
              ...
              <div class="be_choices" style="margin-top:10px;">
                <label class="be_chk">
          ...
          <div class="be_row" style="margin-top:10px;">
            <div class="be_col be_col--grow">
              ...
              <button class="btn btn--sm" type="button" id="be_btn_sig_dasi_clear">Unterschrift löschen</button>
            </div>
          </div>
      ...
      <section class="card card--wide be_card" id="sec_allg">
        ...
        <div class="card__body">
          ...
          <div class="be_meta" style="margin-top:10px;">
            <div class="be_col">
            ...
            <div class="be_col">
              <label class="label be_meta__stack">An-/Abfahrt (h) / Kilometer</label>
              <div class="be_inline2">
                <input class="input" id="be_drive_h" name="drive_h" type="text" placeholder="h">
                <input class="input" id="be_drive_km" name="drive_km" type="text" placeholder="km">
              </div>
            </div>

            <div class="be_col be_meta__employee">
      ...
      <section class="card card--wide be_card" id="sec_work">
        ...
        <div class="card__body">
          ...
          <div class="be_actions" style="margin-top:10px;">
            <button class="crm-fieldchip btnPrimary" type="button" id="be_btn_add_einsatz">Zeile hinzufügen</button>
          ...
          <div class="be_actions" style="margin-top:10px;">
            <button class="crm-fieldchip btnPrimary" type="button" id="be_btn_add_task">Zeile hinzufügen</button>
          </div>
          ...
          <div class="be_actions" style="margin-top:10px;">
            <button class="crm-fieldchip btnPrimary" type="button" id="be_btn_add_material">Zeile hinzufügen</button>
          </div>
      ...
      <section class="card card--wide be_card" id="sec_abnahme">
        ...
        <div class="card__body">
          ...
          <div class="be_row" style="margin-top:10px;">
            <div class="be_col be_col--grow">
              <label class="be_chk">
                ...
                Abnahme erfolgt / Freigabe erteilt.
              </label>

              <label class="be_chk">
                <input type="checkbox" id="be_ab_open" name="ab_open" value="1">
                Abnahme offen / Nacharbeit erforderlich.
              </label>
          ...
          <div class="be_actions" style="margin-top:10px;">
            <button class="crm-fieldchip" type="button" id="be_btn_sig_main_clear">Unterschrift löschen</button>
            <button class="crm-fieldchip btnPrimary" type="submit" name="do" value="doc">Dokumentieren</button>
            <button class="crm-fieldchip" type="submit" name="do" value="pdf">Drucken / PDF</button>
            <button class="crm-fieldchip btnDanger" type="reset" id="be_btn_reset">Änderungen verwerfen</button>
            <div class="be_spacer"></div>
...
<script src="/bericht_einsatz/assets/crm_bericht_einsatz.js?v=1"></script>
